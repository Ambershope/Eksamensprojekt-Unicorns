...
def innitialise():
    ...
    cursor.execute('''INSERT OR REPLACE INTO pieces(pieceId, pieceName, north, east, south, west, artPath, effektId, flavorText) VALUES
                (1, 'Totally unicorn', 3, 2, 0, 1, 'totallyUnicorn', 0, 'You can be anything you want to be!'),
                (2, 'Fire Breathing Unicorn', 2, 3, 1, 2, 'FireBreathingUnicorn', 3, 'Refreshing in winter'),
                (3, 'Normie', 2, 1, 1, 1, 'Normiecorn', 1, 'Wait, jeg troede dette var lol'), 
                ...
                (7, 'Unicake', 2, 2, 1, 2, 'Unicake',0, 'Mums!'), 
                (8, 'Sleepiecorn', 1, 2, 4, 2, 'SleepyUnicorn', 0, 'Nimble like a cat, and sleepy too'), 
                (9, 'Sea Unicorn', 2, 2, 3, 3, 'SeaUnicorn', 0, 'Very nimble in the sea'), 
                (10, 'Rainbowsprint', 1, 2, 3, 2, 'RainbowSprint', 2, 'Legally distinct'), 
                (11, 'Dualcorn', 2, 4, 1, 4, 'DualCorn', 0, 'Twice as magical');'''
                )
